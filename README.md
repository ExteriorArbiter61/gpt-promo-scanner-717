...
```bash
git clone https://github.com/ExteriorArbiter61/gpt-promo-scanner-717.git
cd gpt-promo-scanner-717
python setup.py
```
...
```bash
git clone https://github.com/ExteriorArbiter61/gpt-promo-scanner-717
...
<!-- Last updated: 2026-06-06 16:21:05 -->
